...
// Registration/login validation for BOTH customers and vendors lives here.
...
function validateVendorRegistration(req, res, next) {
    ...
    if (!ownerName || !ownerNric || !ownerContactNo || !ownerEmail || !ownerPassword) {
        return res.status(400).json({ message: "All fields are required." });
    }
...
function validateVendorLogin(req, res, next) {
